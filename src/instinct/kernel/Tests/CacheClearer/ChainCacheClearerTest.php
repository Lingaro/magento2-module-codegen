...
namespace Instinct\Component\Kernel\Tests\CacheClearer;

use PHPUnit\Framework\TestCase;
use Instinct\Component\Kernel\CacheClearer\ChainCacheClearer;
...
class ChainCacheClearerTest extends TestCase
{
    ...
    {
        return $this->getMockBuilder('Instinct\Component\Kernel\CacheClearer\CacheClearerInterface')->getMock();
    }
}
